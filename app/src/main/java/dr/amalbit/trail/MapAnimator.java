...
public class MapAnimator {
    ...
    private static final int GREY = Color.parseColor("#FF00AED9");
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> bangaloreRoute, List<Polyline> polylineList) {
        ...
        polylineList.add(backgroundPolyline);
        polylineList.add(foregroundPolyline);
